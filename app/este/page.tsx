        ...
        <div className={commonStyles.sectionInner}>
          ...
          <div className={commonStyles.cardGrid}>
            <div className={commonStyles.card}>
              <img src="/este1.jpg" alt="最新マシン" className={commonStyles.cardImage} />
            ...
            <div className={commonStyles.card}>
              <img src="/este2.jpg" alt="熟練スタッフ" className={commonStyles.cardImage} />
            ...
            <div className={commonStyles.card}>
              <img src="/este3.jpg" alt="完全個室" className={commonStyles.cardImage} />
